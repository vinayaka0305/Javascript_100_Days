...
for (let i = 0; i < productslist.length; i++) {
  ...
  html += `<div class="product">
              ...
              <div class="priceandaddtocart">
                ...
                <button class="addtocart" productid=${product.id}>Add to cart</button>
              </div>
          </div>`;
}
...
const cartBtn = document.querySelector(".carticon"); //header cart btn
const cartUiNode = document.querySelector(".cartui"); //cart div

cartBtn.addEventListener("click", () => {
  cartUiNode.setAttribute("class", "cartui cartopened");
});

const closeCartbtn = document.querySelector(".closecart"); //close cart btn in cart div
...
function renderCart() {
  ...
  cartBtn.setAttribute("items", cartItems.length);
}
