...
const cartUNiNode = document.querySelector(".cartui");

cartBtn.addEventListener("click", () => {
  cartUNiNode.setAttribute("class", "cartui cartopened");
});

const closeCartBtn = document.querySelector(".closecart");

closeCartBtn.addEventListener("click", () => {
  cartUNiNode.setAttribute("class", "cartui");
});
...
addToCartBtns.forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    console.log(product);
    if (product) {
      const exisisting = cartItems.find((item) => item.id == productId);
